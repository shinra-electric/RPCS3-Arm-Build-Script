...
# Make an icon
mkdir rpcs3.iconset
sips -z 16 16     rpcs3.png --out rpcs3.iconset/icon_16x16.png
sips -z 32 32     rpcs3.png --out rpcs3.iconset/icon_16x16@2x.png
sips -z 128 128   rpcs3.png --out rpcs3.iconset/icon_128x128.png
sips -z 256 256   rpcs3.png --out rpcs3.iconset/icon_128x128@2x.png
sips -z 512 512   rpcs3.png --out rpcs3.iconset/icon_512x512.png
cp rpcs3.png rpcs3.iconset/icon_512x512@2x.png
